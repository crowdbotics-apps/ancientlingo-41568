"""
Django settings for ancientlingo_41568 project.
...
ROOT_URLCONF = 'ancientlingo_41568.urls'
...
WSGI_APPLICATION = 'ancientlingo_41568.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ancientlingo_41568 API",
    "DESCRIPTION": "API documentation for ancientlingo_41568 App",
    "VERSION": "v1",
}
